CREATE DATABASE  IF NOT EXISTS `eatery-hub` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `eatery-hub`;
...
INSERT INTO `food_items` VALUES (1,'Burger',6.00),(2,'Pasta',7.00),(3,'Pizza',8.00),(4,'Coke',5.00),(5,'Spring Roll',6.00),(6,'Noodles',9.00),(7,'Manchurian',4.00),(8,'Chilli Potato',7.00),(9,'Samosa',5.00);
...
--
-- Dumping routines for database 'eatery-hub'
--
